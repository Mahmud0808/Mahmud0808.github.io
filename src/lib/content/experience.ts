  ...
  experiences: [
    {
      ...
      tasks: [
        ...
        'Collaborated with a cross-functional team of developers and designers in the creation of the product.',
      ],
    },
    {
      company: 'ThunderDex',
      ...
      tasks: [
        ...
        'Collaborated closely with a skilled American developer.',
      ],
    },
    {
      company: 'SuperiorExtended',
      ...
      tasks: [
        ...
        'Worked remotely with a distributed team from around the globe.',
      ],
    },
  ],
};
